/**
 * =============================================================
 * File         :OutCoinCounterViewModel.cs
 * Summary      :OutCoinCounterViewModelのビューモデル
...
{
        public class OutCoinCounterViewModel : BindableBase
        {
                #region メンバ変数
                // =======================================================
                // メンバ変数
                ...
                /// OUT枚数
                /// </summary>
                public ReactiveProperty<uint> OutCoin { get; }
                #endregion
                ...
                /// コンストラクタ
                /// </summary>
                public OutCoinCounterViewModel( DataManager p_DataManager )
                {
                        ...
                        OutCoin = m_DataManager.ToReactivePropertyAsSynchronized( m => m.OutCoin ).AddTo( m_Disposables );
                        OutCoin.Subscribe( outcoin => set_number( outcoin ) );
                        SixthDigit = null;
                        FifthDigit = null;
                        ForthDigit = null;
                        ThirdDigit = null;
