/**
 * =============================================================
 * File         :InCoinCounterViewModel.cs
 * Summary      :InCoinCounterViewModelのビューモデル
...
namespace Pachislot_DataCounter.ViewModels
{
        public class InCoinCounterViewModel : BindableBase
        {
                ...
                /// コンストラクタ
                /// </summary>
                public InCoinCounterViewModel( DataManager p_DataManager )
                {
                        ...
                        InCoin = m_DataManager.ToReactivePropertyAsSynchronized( m => m.InCoin ).AddTo( m_Disposables );
                        InCoin.Subscribe( incoin => set_number( incoin ) );
                        SixthDigit = null;
                        FifthDigit = null;
                        ForthDigit = null;
                        ThirdDigit = null;
