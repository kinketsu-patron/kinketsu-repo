...
namespace Pachislot_DataCounter.ViewModels
{
        public class BBCounterViewModel : BindableBase
        {
                ...
                /// ビッグボーナス回数
                /// </summary>
                public ReactiveProperty<uint> BigBonus { get; }
                #endregion
                ...
                /// コンストラクタ
                /// </summary>
                public BBCounterViewModel( DataManager p_DataManager )
                {
                        ...
                        BigBonus = m_DataManager.ToReactivePropertyAsSynchronized( m => m.BigBonus ).AddTo( m_Disposables );
                        BigBonus.Subscribe( bb => set_number( bb ) );
                        ThirdDigit = null;
                        SecondDigit = null;
